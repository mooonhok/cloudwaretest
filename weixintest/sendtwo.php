...
//		})
	...
	<script>
		$.ajax({
			url: "http://api.uminfor.cn/goods_package_nedb.php/getGoodsPackages",
			dataType: 'json',
			type: 'get',
			ContentType: "application/json;charset=utf-8",
			data: JSON.stringify({}),
		...
		//获取省份和城市列表1
		$.ajax({
			url: "http://api.uminfor.cn/city.php/province",
			dataType: 'json',
			type: 'get',
			ContentType: "application/json;charset=utf-8",
			data: JSON.stringify({}),
		...
		function getPro1() {
			...
			$.ajax({
				url: "http://api.uminfor.cn/city.php/city?pid=" + pid,
				dataType: 'json',
				type: 'get',
				ContentType: "application/json;charset=utf-8",
				data: JSON.stringify({}),
	...
	<script>
		...
		$.ajax({
			url: "http://api.uminfor.cn/city.php/citys",
			dataType: 'json',
			type: 'get',
			ContentType: "application/json;charset=utf-8",
			data: JSON.stringify({}),
	...
	<script type="text/javascript">
		...
		function loadsend(openid,tenant_id) {
			$.ajax({
				url: "http://api.uminfor.cn/customer.php/wxaddress?wx_openid=" + openid,
				beforeSend: function(request) {
					request.setRequestHeader("tenant-id", tenant_id);
				},
				dataType: 'json',
	...
	<script type="text/javascript">
		function edit(id){
					$.ajax({
					url: "http://api.uminfor.cn/customer.php/onewxaddress",
					beforeSend: function(request) {
						request.setRequestHeader("tenant-id", tenant_id);
					},
					dataType: 'json',
			...
			if(!/^1[34578]\d{9}$/.test(phone_3)){
				...
				$.ajax({
					url: "http://api.uminfor.cn/customer.php/customer_address",
					beforeSend: function(request) {
						request.setRequestHeader("tenant-id", tenant_id);
					},
					dataType: 'json',
	...
	<script type="text/javascript">
		...
		function delet(id,tenant_id) {
			...
			$.ajax({
				url: "http://api.uminfor.cn/customer.php/customer?customerid=" + id+"",
				beforeSend: function(request) {
					request.setRequestHeader("tenant-id", tenant_id);
				},
				dataType: 'json',
	...
	<script type="text/javascript">
		...
		$("#subaddress3").on("click", function() {
			...
			if(!/^1[34578]\d{9}$/.test(phone_1)) {
				...
				$.ajax({
					url: "http://api.uminfor.cn/customer.php/plus_customer",
					beforeSend: function(request) {
						request.setRequestHeader("tenant-id", tenant_id);
					},
					dataType: 'json',
	...
	<script type="text/javascript">
		$(".tijiao").on('click', function() {
			...
			if(customer_send_id == "" || customer_send_id == null) {
				...
				$.ajax({
					url: "http://api.uminfor.cn/wxmessage.php/wxmessage_insert",
					beforeSend: function(request) {
						request.setRequestHeader("tenant-id", tenant_id);
					},
					dataType: 'json',
